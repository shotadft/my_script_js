...
if (use_language === 'ja-JP' || use_language === 'ja') {
		language_money = '\xA5';
		freePrice_text = '無料';
} else if (use_language === 'zh' || use_language === 'zh-Hans' || use_language === 'zh-SG' || use_language === 'zh-CN' ||
		use_language === 'zh-Hant' || use_language === 'zh-HK' || use_language === 'zh-TW' || use_language === 'zh-MO') {
		language_money = '元';
		freePrice_text = '免费';
} else {
		language_money = '\x24';
...
export function Price(Divided, Price_n) {
		document.addEventListener("DOMContentLoaded", function () {
				...
				if (this.Price_n === 0) {
						if (use_language === 'zh' || use_language === 'zh-Hans' || use_language === 'zh-SG' || use_language ===
								'zh-CN' || use_language === 'zh-Hant' || use_language === 'zh-HK' || use_language === 'zh-TW' ||
								use_language === 'zh-MO') {
